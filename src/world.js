...
export const ROUTE = {
  ...
  corners: [],                   // 90° 코너 [{ s, turn }] — turn −π/2 우회전 · +π/2 좌회전. 비면 옛 직선과 동일
  ...
  temple: { s: 352, lat: -52, y: 5, yaw: 0.4 },      // 두 번째 정차 지점 왼쪽 언덕
  stops: [
  ...
  districts: [
    { s1: 164, name: '초가 마을', choga: 0.85, wall: 0.25, cap: 0.75, speed: 1.15, mix: { brute: 0.02, bomber: 0.06, runner: 0.14 }, props: ['haystack', 'jangdokdae', 'well', 'jige', 'chicken-coop', 'brush-fence', 'mortar-pestle', 'straw-mat'], lane: ['haystack', 'jige', 'straw-mat'] },
    { s1: 314, name: '기와 골목', choga: 0.45, wall: 0.7, cap: 0.9, speed: 1.22, mix: { brute: 0.04, bomber: 0.10, runner: 0.20 }, props: ['stone-lantern', 'jangdokdae', 'stone-wall', 'straw-mat', 'jangseung-pair', 'garden-rock', 'well'], lane: ['jangdokdae', 'haystack', 'jangseung'] },
    { s1: 464, name: '육조 거리', choga: 0.1, wall: 0.9, cap: 1.0, speed: 1.3, mix: { brute: 0.07, bomber: 0.14, runner: 0.26 }, props: ['stone-lantern', 'haetae', 'pagoda', 'rank-stones', 'ding-censer', 'stone-wall', 'danggan'], lane: ['stone-lantern', 'haetae', 'rank-stones'] },
  ],
};
