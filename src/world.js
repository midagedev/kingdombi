...
export const ROUTE = {
  ...
  // speed 1.55~1.75(2026-09-04, 전 1.45~1.65 — "더 공격적으로 와도 괜찮겠어"): 마차 5 m/s 보다 모두 빨라야 파가 밀물처럼 닥쳐 12 m 뒤에 뭉친다 — 느리면 14~55 m 에 흩어져 작은 점을 하나씩 잡는 게임이 된다(실측 3 킬/초).
  // speed 는 마차 5.0 m/s 를 보통형(3.6~5.2)이 따라잡을 만큼은 돼야 한다 — 1.15 면 절반, 1.3 이면 대부분이 붙는다.
  districts: [
    { s1: 164, name: '초가 마을', choga: 0.85, wall: 0.25, cap: 0.75, speed: 1.55, mix: { brute: 0.02, bomber: 0.06, runner: 0.14 }, props: ['haystack', 'jangdokdae', 'well', 'jige', 'chicken-coop', 'brush-fence', 'mortar-pestle', 'straw-mat'], lane: ['haystack', 'jige', 'straw-mat'] },
    { s1: 314, name: '기와 골목', choga: 0.45, wall: 0.7, cap: 0.9, speed: 1.65, mix: { brute: 0.04, bomber: 0.10, runner: 0.20 }, props: ['stone-lantern', 'jangdokdae', 'stone-wall', 'straw-mat', 'jangseung-pair', 'garden-rock', 'well'], lane: ['jangdokdae', 'haystack', 'jangseung'] },
    { s1: 464, name: '육조 거리', choga: 0.1, wall: 0.9, cap: 1.0, speed: 1.75, mix: { brute: 0.07, bomber: 0.14, runner: 0.26 }, props: ['stone-lantern', 'haetae', 'pagoda', 'rank-stones', 'ding-censer', 'stone-wall', 'danggan'], lane: ['stone-lantern', 'haetae', 'rank-stones'] },
  ],
};
